...
class TicTacToe:
    ...
    @staticmethod
    def print_board_numb():
        # 0 | 1 | 2 etc (tells us what number corresponds to want box)
    ...
    def winner(self, square, letter):
        ...
        if square % 2 == 0:
            ...
            diagonal2 = [self.board[i]
                         for i in [2, 4, 6]]  # right to right diagonal
